    ...
    def generate(self, gentype, LR, n_iter1=6, n_iter2=10):
        ...
        for i in range(n_iter1):
            if gentype == "gibbs":
                ...
                model_samples_ori_z = self.frame.generate("langv-x", self.draw_p, n_iter2, z0=zp, stepsize=self.x_gen_stepsize,
                                                     anneal=self.x_gen_anneal, freeze=self.x_gen_freeze, x_range=[0., 1.])
            elif gentype == "langv-z":
                model_samples_ori_z = self.frame.generate("langv-z", self.draw_p, n_iter2, z0=zp, stepsize=self.z_gen_stepsize,
